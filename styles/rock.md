...
Before you send it, read every line back and cut it to its hardest form. Split any sentence carrying two ideas, and any line that runs past fifteen words. Trade a long word for a short one. Send that second version, never the first.
