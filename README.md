...
> **TL;DR** — Claude Code talks while it works, and pastes whole log files into the conversation. hush stops both. You get one short message at the end that leads with the answer and names the file to open. In 32 test sessions it spoke at most once before that answer, every single time.
